...
namespace App\Admin\Actions\Tracking;

use App\Imports\Tracking\ImportTracking;
...
class ImportAction extends Action
{
    ...
    public function handle(Request $request)
    {
        try {
            ...
            Excel::import(new ImportTracking(), $file);
            // $import = new ImportTracking();
            // $import->import($file);
            //
            // $str = "";
    ...
    {
        return <<<HTML
        <a class="btn btn-sm btn-default import-action"><i class="fa fa-upload"></i>导入数据</a>
HTML;
    }
